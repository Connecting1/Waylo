...
import 'getGenderPage.dart';

class GetBirthDatePage extends StatefulWidget {
  const GetBirthDatePage({super.key});

  @override
  State<GetBirthDatePage> createState() => _GetBirthDatePageState();
}

class _GetBirthDatePageState extends State<GetBirthDatePage> {
  ...
  Future<void> _goToGenderPage(BuildContext context) async {
    if (_isBirthDateValid) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const GetGenderPage()),
      );
    }
  }
