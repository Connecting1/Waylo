...
class GetNickNamePage extends StatefulWidget {
  const GetNickNamePage({super.key});

  @override
  State<GetNickNamePage> createState() => _GetNickNamePageState();
}

class _GetNickNamePageState extends State<GetNickNamePage> {
